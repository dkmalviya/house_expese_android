...
class ProfileService{
  ...
  profileDetails['email'] = profileData.docs[0].data()['email'];
  profileDetails['currentHouseId'] = profileData.docs[0].data()['currentHouseId'];
  profileDetails['userId'] = profileData.docs[0].data()['userId'];
